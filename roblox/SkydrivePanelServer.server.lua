...
local function doHeartbeat()
    ...
    local body = {
        ...
        cpuUsage = math.floor(stats and stats:GetTotalMemoryUsageMb and stats:GetTotalMemoryUsageMb() or 0) % 100,
        memoryMB = math.floor(stats and stats:GetTotalMemoryUsageMb and stats:GetTotalMemoryUsageMb() or 0),
        players = players,
        logs = logsToSend,
    }
